...
class E03 {
        ...
        try (Scanner s = new Scanner(System.in)) {
            ...
            long elapsed = elapsed(() -> {
                consumeGroup(s, (gameName) -> {
                    Optional<Game> maybeGame = linearSearch(selected, (game) -> {
            ...
            File perfLog = new File("767637_sequencial.txt");
    ...
    private static <T> Optional<T> linearSearch(Iterable<T> iter, Predicate<T> pred) {
        for (T elem : iter) {
            if (pred.test(elem)) {
