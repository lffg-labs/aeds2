...
class E02 {
    public static void main(String[] args) throws IOException {
        ...
        LinkedStack<Game> selectedGames = new LinkedStack<Game>();
        ...
        // Sadly this is O(n^2), but who cares.
        for (int i = 0; i < selectedGames.length(); i++) {
            System.out.println("[" + i + "] " + selectedGames.getRev(i).toString());
            // .............................................. O(n) ^
        }
    }
